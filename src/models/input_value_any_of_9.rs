...
impl InputValueAnyOf9 {
    pub fn new(interaction_type: Option<InteractionType>, interacted_at: Option<serde_json::Value>, owner_actor: crate::models::InputValueAnyOf9OwnerActor) -> InputValueAnyOf9 {
        InputValueAnyOf9 {
            interaction_type,
            interacted_at,
