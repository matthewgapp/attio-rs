...
pub struct AttributeConfigCurrency {
...
impl AttributeConfigCurrency {
    /// Configuration available for attributes of type \"currency\".
    pub fn new(default_currency_code: Option<DefaultCurrencyCode>, display_type: Option<DisplayType>) -> AttributeConfigCurrency {
